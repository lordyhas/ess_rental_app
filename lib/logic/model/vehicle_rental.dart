...
class Drf extends StuffRental{
  ...
  static const empty = Drf(id: '', mark: '', vehicleType: VehicleRentalType.A, description: '');


  @override
  RentalType get rentalType => throw UnimplementedError();
